...
export function ShareModal({
  ...
  const candidateAuthTypes: ShareAuthType[] = ['public', 'password']
  // Keep the saved mode visible even if newly disallowed, so the current state shows.
  if (savedAccessMode !== 'private' && !candidateAuthTypes.includes(savedAccessMode)) {
    candidateAuthTypes.push(savedAccessMode)
  }
