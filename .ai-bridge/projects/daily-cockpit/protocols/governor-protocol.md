...
Before implementation begins, the proposal must survive multiple independent reasoning passes.
...
2. Governor A reconstructs intent and grills the problem.
3. Governor A produces a packet: architecture, assumptions, risks, acceptance criteria.
4. Governor B reads the packet and tries to disprove it.
...
6. Governor A reviews the critique and either accepts, rejects with evidence, or synthesizes a better design.
